...
var StaffMembermComponent = (function () {
    function StaffMembermComponent() {
        ...
        this.model = new staffMember_1.StaffMember('Dimuthuuu', 'Darshana', 'Senanayaka', '872173137VC', '2016-01-02', 'Galle', 'Galle', 'Galle', 34234234, 34234234, 'dim912@gmail.com');
    ...
    StaffMembermComponent.prototype.newHero = function () {
        var _this = this;
        this.model = new staffMember_1.StaffMember('Dimuthuuu', 'Darshana2', 'Senanayaka2', '872173137VC', '2016-01-02', 'Galle', 'Galle', 'Galle', 34234234, 34234234, 'dim912@gmail.com');
        this.active = false;
